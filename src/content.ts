...
export const CLIENT_LOGOS = [
  ...
  { src: '/logos/alezzi_logo_vectorial.svg', alt: 'Alezzi' },
  { src: '/logos/augsburg_international_logo.svg', alt: 'Augsburg International' },
  { src: '/logos/BCP-CA-MA-briotherm-XPS-Logo-giasxps.ro_.jpg', alt: 'Briotherm' },
  { src: '/logos/denis_spedition_logo.webp', alt: 'Denis Spedition' },
  { src: '/logos/farplas_logo.png', alt: 'Farplas' },
  { src: '/logos/neoclinique_logo.svg', alt: 'Neoclinique' },
  { src: '/logos/nr1_fitness_logo_vectorial.svg', alt: 'NR1 Fitness' },
  { src: '/logos/clinica_medicala_ramed_vectorial.webp', alt: 'RaMED' },
  { src: '/logos/romstyl_logo.png', alt: 'Romstyl' },
  { src: '/logos/BCP-CA-MA-Spitalul-Policlinica-Sf-Ioan-Logo-spitalsfantulioan.ro_.jpg', alt: 'Spitalul Sf. Ioan' },
  { src: '/logos/stone_calibre_logo.png', alt: 'Stone Calibre' },
  { src: '/logos/techsylvania_logo_vectorial.svg', alt: 'Techsylvania' },
  { src: '/logos/bmf_logo.svg', alt: 'BMF Group' },
  { src: '/logos/cgs_management_logo_vectorial.svg', alt: 'CGS Management' },
  { src: '/logos/BCP-CA-MA-ECM-Euro-Gas-Systems-Logo-eurogassystems.com_.png', alt: 'Euro Gas Systems' },
  { src: '/logos/sunridge_partners_logo_vectorial.svg', alt: 'Sunridge Partners' },
  { src: '/logos/aic_trucks_logo.png', alt: 'AIC Trucks' },
  { src: '/logos/big_mega_renewable_energy_logo_vectorial.svg', alt: 'Big Mega Renewable' },
  { src: '/logos/omv_petrom_logo_vectorial.svg', alt: 'OMV Petrom' },
  { src: '/logos/BCP-EIA-MA-tenergie-Logo-tenergie.fr_.png', alt: 'Tenergie' },
  { src: '/logos/voltalia_logo_vectorial.svg', alt: 'Voltalia' },
  { src: '/logos/grenenergy_logo.svg', alt: 'Grenergy' },
  { src: '/logos/perpetum_logo.webp', alt: 'Perpetum' },
  { src: '/logos/pne_logo.svg', alt: 'PNE' },
  { src: '/logos/estari_logo.svg', alt: 'Estari' },
  { src: '/logos/forty_management_logo.svg', alt: 'Forty Management' },
  { src: '/logos/aic_logo.svg', alt: 'AIC' },
  { src: '/logos/tester_grup_logo.svg', alt: 'Tester Grup' },
  { src: '/logos/elon_logo.svg', alt: 'Elon' },
  { src: '/logos/highcrowd_logo.svg', alt: 'HighCrowd' },
  { src: '/logos/axigen_logo.webp', alt: 'Axigen' },
  { src: '/logos/BCP-TA-MA-Jonas-Software-Logo-jonassoftware.com_.png', alt: 'Jonas Software' },
  { src: '/logos/qubiz_logo_vectorial.svg', alt: 'Qubiz' },
  { src: '/logos/zitec_logo_vectorial.svg', alt: 'Zitec' },
  { src: '/logos/zurich_insurance_group_logo_vectorial.svg', alt: 'Zurich' },
  { src: '/logos/creditstar_group_logo.png', alt: 'Creditstar' },
]
